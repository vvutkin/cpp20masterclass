...
int main() {
  ...
  // exp : f(x) = e ^ x , where e = 2.71828 . Test the result here against a
  // calculator
  ...
  // log : reverse function of pow. if 2^3 = 8 , log 8 in base 2 = 3.  Log is
  // like asking
  //  to which exponent should we elevate 2 to get eight ? Log, by default
  //  computes the log in base e. There also is another function which uses base
  //  10 called log10
  ...
  // log10 , 10 ^ 4 = 10000  , to get 10k , you'd need to elevate 10 to the
  // power of ? , this is log in base 10
  ...
  // round. Halfway points are rounded away from 0. 2,5 is rounded to 5 for
  // example
